          ...
          {activeTab === "lesson" ? (
            <>
              <div className="lesson-form-grid">
                ...
                <label><span>Время начала</span><input type="time" min="08:00" max="21:30" step="60" value={lessonDraft.startTime} onChange={(event) => updateLesson("startTime", event.target.value)} required disabled={isSubmitting} /></label>
