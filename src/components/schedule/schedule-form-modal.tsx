        ...
        {series && !editing ? (
          ...
          <form aria-busy={isSubmitting} onSubmit={(event) => { event.preventDefault(); void submit(); }}>
            <div className="lesson-form-grid">
              ...
              <label><span>Время окончания</span><input type="time" step="300" value={draft.endTime} onChange={(event) => update("endTime", event.target.value)} required disabled={isSubmitting} /></label>
